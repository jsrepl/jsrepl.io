...
// Based on https://github.com/sdegutis/vanillajsx.com/blob/4d053181f5a15d52508ec8b1f5be82c5610a8bc6/site/token-provider.ts
// Differences:
// - * 5. Highlight var/let/const names - disabled
// ----------------------------------------------------------------
...
export const monacoTypescriptTokenProvider = {

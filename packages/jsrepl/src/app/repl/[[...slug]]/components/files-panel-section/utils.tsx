...
export function findTreeDataItem(path: string, root: TreeDataItem): TreeDataItem | undefined {
  const dirNames = path.split('/').slice(1)
  return dirNames.reduce<TreeDataItem | undefined>(

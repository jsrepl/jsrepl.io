...
const selectTriggerVariants = cva(
  ...
  ],
  {
    variants: {
      ...
      variantSize: {
        default: ['h-9', 'px-3', 'py-2', 'rounded-md', 'text-sm', 'gap-2'],
        sm: ['h-7', 'px-1.5', 'py-0.5', 'rounded', 'text-sm', 'gap-1'],
      },
    },
    defaultVariants: {
      variant: 'default',
...
>(({ className, children, variant, variantSize, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(selectTriggerVariants({ variant, variantSize, className }))}
    {...props}
  >
    {children}

...
export default defineConfig(({ mode }) => {
  ...
  function getJSReplOrigin() {
    ...
    const info = {
      NUXT_ENV_VERCEL_ENV: env.NUXT_ENV_VERCEL_ENV,
      NUXT_ENV_VERCEL_BRANCH_URL: env.NUXT_ENV_VERCEL_BRANCH_URL,
      NUXT_ENV_VERCEL_PROJECT_PRODUCTION_URL: env.NUXT_ENV_VERCEL_PROJECT_PRODUCTION_URL,
      NUXT_ENV_VERCEL_URL: env.NUXT_ENV_VERCEL_URL,
